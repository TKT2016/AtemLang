...
public class LambdaRefMarker {
    ...
    public LambdaRefMarker(JCLambda source, ExpandContext context)
    {
        this.source =source;
    ...
    JCVariableDecl makeVarDecl()
    {
        ...
        jcVariableDecl.expandKind= JCVariableDecl.ExpandKindEnum.LambdaRef;
