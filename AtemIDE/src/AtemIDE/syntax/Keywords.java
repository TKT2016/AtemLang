package AtemIDE.syntax;

import AtemIDE.ResourceLoader;
...
public class Keywords {
    ...
    public static void onKeywordsBind() {
     //   InputStream stream = Thread.currentThread().getContextClassLoader().getResourceAsStream("/AtemIDE/res/files/classes.txt");
        InputStream stream = ResourceLoader.getResourceAsStream("/AtemIDE/res/files/classes.txt");
