...
public class NewFileController implements Initializable {
    ...
    private void createButtonAction() {
       ...
       /* if(mainController!=null)
        {
            mainController.updateFilesTreeView();
        }*/
    }
...
/*
    public static void show(MainController mainController)
    {
        fileController.mainController = mainController;
